...
public class MedicsData {
   ...
   // private String fav_user;
    ...
    public MedicsData(String groupMedics,String fav, String avatarUri,
    ...
    public MedicsData(Cursor cursor) {
       ...
       // fav = cursor.getString(cursor.getColumnIndex(MedicsEntry.FAV));
        fav = cursor.getString(cursor.getColumnIndex(MedicsEntry.FAV));
        ...
        setIndications(cursor.getString(cursor.getColumnIndex(MedicsEntry.INDICATIONS)));
    ...
    public ContentValues toContentValues() {
        ...
        values.put(MedicsEntry.FAV, fav);
        ...
        values.put(MedicsEntry.INDICATIONS, getIndications());
